...
- Write a C compiler
  ...
  - [Part 2: Unary ators](https://norasandler.com/2017/12/05/Write-a-Compiler-2.html)
...
### Operating system & VM's

- [Virtual machine in C](https://blog.felixangell.com/virtual-machine-in-c/)
- [Writing a Game Boy emulator, Cinoop](https://cturt.github.io/cinoop.html)
- [Building a software and hardware stack for a simple computer from scratch](https://www.youtube.com/watch?v=ZjwvMcP3Nf0&list=PLU94OURih-CiP4WxKSMt3UcwMSDM3aTtX) [video]
...
- [Build a minimal multi-tasking kernel for ARM from scratch](https://github.com/jserv/mini-arm-os)
- [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial)
